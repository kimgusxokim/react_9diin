    ...
    <header className="fixed top-0 z-10 flex w-full items-center justify-center bg-[#121212]">
      <div className="flex w-full max-w-[1328px] items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-5">
          <img src="https://github.com/9diin.png" alt="@LOGO" className="h-6 w-6 cursor-pointer" />
          <div className="flex items-center gap-5">
        ...
        {/* 로그인 UI */}
        <div className="font-semibold text-muted-foreground transition-all duration-500 hover:text-white">로그인</div>
      </div>
    </header>
  )
}
